-- ============================================================================
-- FINAL SAFE MIGRATION - NAVAA.AI
-- ============================================================================
-- This migration works with EXISTING user_profiles TABLE
...
-- STEP 2: EXTEND USER_PROFILES TABLE - Add missing columns safely
-- ============================================================================
...
-- STEP 3: RLS POLICIES FOR USER_PROFILES
-- ============================================================================
...
-- STEP 4: ASSESSMENTS TABLE - For Dashboard statistics
-- ============================================================================
...
-- STEP 5: USER_SUBSCRIPTIONS TABLE - For tariff management
-- ============================================================================
...
-- STEP 6: USER_TARIFF_INFO VIEW - For check-case-limit API
-- ============================================================================
...
-- STEP 7: DEFINITIVE TRIGGER - Automatic user_profiles creation
-- ============================================================================
...
-- Set role for existing users where missing
UPDATE public.user_profiles 
SET role = 'user'
WHERE role IS NULL;

-- Set timestamps for existing users where missing
UPDATE public.user_profiles 
...
-- STEP 10: PERMISSIONS - Ensure proper access
-- ============================================================================
...
-- STEP 11: VERIFICATION - Check everything is working
-- ============================================================================
...
SELECT 'SUCCESS: Final safe migration completed!' as status,
       'All backend errors should now be fixed.' as details;

-- ============================================================================
-- MIGRATION COMPLETE
-- ============================================================================
-- This migration:
-- ✅ Extends existing user_profiles table with missing columns
-- ✅ Fixes user_profiles 500 errors (all required columns added)
