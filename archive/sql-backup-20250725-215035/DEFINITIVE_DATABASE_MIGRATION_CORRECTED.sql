-- ============================================================================
-- DEFINITIVE DATABASE MIGRATION - NAVAA.AI (CORRECTED FOR VIEW STRUCTURE)
-- ============================================================================
-- This single file replaces ALL other SQL migrations
-- CRITICAL: user_profiles is a VIEW, not a TABLE - this migration handles that
-- ============================================================================
...
-- STEP 2: INVESTIGATE CURRENT STRUCTURE
-- ============================================================================
-- Check if user_profiles is a view or table
...
-- STEP 3: CREATE ACTUAL USER_PROFILES TABLE (if it's currently a view)
-- ============================================================================
-- First, drop the view if it exists
DROP VIEW IF EXISTS public.user_profiles;

-- Create the actual user_profiles table with all required columns
CREATE TABLE IF NOT EXISTS public.user_profiles (
    ...
    first_name TEXT,
    last_name TEXT,
    role TEXT DEFAULT 'user' CHECK (role IN ('admin', 'user', 'test_user')),
...
-- ============================================================================
-- If there are existing users in auth.users without profiles, create them
...
-- STEP 6: ASSESSMENTS TABLE - For Dashboard statistics
-- ============================================================================
...
-- STEP 7: USER_SUBSCRIPTIONS TABLE - For tariff management
-- ============================================================================
...
-- STEP 8: USER_TARIFF_INFO VIEW - For check-case-limit API
-- ============================================================================
...
-- STEP 9: DEFINITIVE TRIGGER - Automatic user_profiles creation
-- ============================================================================
...
-- STEP 11: PERMISSIONS - Ensure proper access
-- ============================================================================
...
-- STEP 12: VERIFICATION - Check everything is working
-- ============================================================================
SELECT 'VERIFICATION RESULTS:' as status;

-- Check user_profiles is now a table
...
SELECT 'user_profiles count:' as check_type,
       COUNT(*) as result
FROM public.user_profiles;

-- Final success message
SELECT 'SUCCESS: Definitive database migration completed!' as status,
       'user_profiles converted from VIEW to TABLE with all data preserved' as details;

-- ============================================================================
-- MIGRATION COMPLETE
-- ============================================================================
-- This migration:
-- ✅ Converts user_profiles from VIEW to TABLE
-- ✅ Preserves all existing user data
-- ✅ Fixes user_profiles 500 errors (proper table structure)
