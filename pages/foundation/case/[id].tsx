  ...
  const handleResponseSubmit = async (response: FoundationResponse) => {
    ...
    try {
      ...
      const mockAssessment: FoundationAssessment = {
        ...
        feedback: {
          strengths: [
            'Gute Strukturierung der Problemanalyse',
            'Klare Argumentation bei der Lösungsfindung',
          ],
          improvements: [
            'Mehr Fokus auf quantitative Aspekte',
            'Berücksichtigung von Implementierungsrisiken',
          ],
          detailed_feedback:
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        {/* Response Handler or Assessment */}
        {!assessment ? (
          <ResponseHandler
            case={foundationCase}
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-green-800 text-sm">{assessment.feedback.detailed_feedback}</p>
              </div>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => {
                    // Navigate to next case - will be implemented later
                    alert('Nächster Case - wird in AP3.4 implementiert');
                  }}
