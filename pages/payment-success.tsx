      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vielen Dank für dein Vertrauen! Dein navaa.ai Plus-Abonnement wurde erfolgreich aktiviert. 
            Du kannst jetzt alle erweiterten Features nutzen und bis zu 25 Cases pro Woche bearbeiten.
          </p>

          {/* Features Overview */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8 max-w-md mx-auto">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Deine neuen Features:</h3>
