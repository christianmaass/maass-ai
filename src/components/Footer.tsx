    ...
    <footer className="w-full py-12 mt-12 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Box 1 */}
          <div>
            <img src={logo} alt="navaa Logo" className="h-14 w-auto mb-4" />
            <div className="flex gap-3 mb-2">
              <span className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-400">S</span>
              <span className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-400">T</span>
              <span className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-400">M</span>
            </div>
