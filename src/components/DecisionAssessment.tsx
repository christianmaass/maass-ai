...
type Pattern = 'ALL_JA' | 'ALL_NEIN' | 'ALL_UNSICHER' | 'MAJ_JA' | 'MAJ_NEIN' | 'MAJ_UNSICHER' | 'MIX_1_1_1';
    ...
    <div className="bg-transparent rounded-xl p-6 md:p-8">
        {!showResult ? (
            ...
            <div className="w-full bg-white rounded-full h-2 relative overflow-hidden">
              ...
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: progressPercentage > 0 ? '0 0 12px rgba(0, 143, 117, 0.3), 0 0 24px rgba(0, 143, 117, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.2)' : 'none'
                }}
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-navaa-gray-900">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-navaa-gray-900">
              {result?.title}
            </h3>
            <p className="text-navaa-gray-700 text-lg max-w-2xl">
              {result?.text}
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <p className="text-xs text-navaa-gray-500 max-w-md">
              Kurzfakten: Nur rund 1 von 5 Unternehmen hält seine Entscheidungsqualität für wirklich hochwertig. 
              Viele scheitern bei der Umsetzung – genau hier setzt NAVAA an.
            </p>
          </div>
