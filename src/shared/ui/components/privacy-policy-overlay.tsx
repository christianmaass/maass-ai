          ...
          <div className="space-y-6 text-navaa-gray-700 text-sm leading-relaxed">
            <section>
              ...
              <p className="mb-4">
                ...
                Kontaktdaten können Sie dem Abschnitt &quot;Hinweis zur Verantwortlichen
              ...
              <p className="mb-4">
                ...
                Aufsichtsbehörde zu. Hierzu sowie zu weiteren Fragen zum Datenschutz können Sie sich
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                gesetzlichen Datenschutzbestimmungen sowie dieser Datenschutzerklärung. Wenn Sie
              ...
              <p className="mb-4">
                WERDEN DIE PERSONENBEZOGENEN DATEN AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F
                DSGVO VERARBEITET, HABEN SIE JEDERZEIT DAS RECHT, AUS GRÜNDEN, DIE SICH AUS IHRER
                ...
                IHRE BETROFFENEN PERSONENBEZOGENEN DATEN NICHT MEHR VERARBEITEN, ES SEI DENN, WIR
                ...
                ART. 21 ABS. 1 DSGVO). WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM
                ...
                VERBINDUNG STEHT. WIDERSPRECHEN SIE, WERDEN IHRE PERSONENBEZOGENEN DATEN
                ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH NACH
                ART. 21 ABS. 2 DSGVO).
              </p>
              ...
              <p className="mb-4">
                ...
                Ihrer Browserzeile. Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert ist, können die
              ...
              <p className="mb-4">
                ...
                die Verarbeitung Ihrer personenbezogenen Daten unrechtmäßig geschah/geschieht,
                ...
                personenbezogenen Daten zu verlangen. Wenn Sie einen Widerspruch nach Art. 21 Abs. 1
            ...
            <section>
              ...
              <p className="mb-4">
                Diese Website verwendet Cookies. Cookies sind kleine Textdateien und richten auf
                Ihrem Endgerät keinen Schaden an. Sie werden entweder vorübergehend für die Dauer
                einer Sitzung (Session-Cookies) oder dauerhaft (dauerhafte Cookies) auf Ihrem
                Endgerät gespeichert. Session-Cookies werden nach Ende Ihres Besuchs automatisch
                gelöscht. Dauerhafte Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese
                ...
                Cookies zur Abwicklung von Zahlungsdienstleistungen). Cookies haben verschiedene
                ...
                oder die Anzeige von Videos). Andere Cookies können zur Auswertung des
                Nutzerverhaltens oder zu Werbezwecken verwendet werden. Sofern Cookies zur
                Datenverarbeitung auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert werden,
                ist unser berechtigtes Interesse die Verbesserung der Funktionalität unserer
                Website. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B. eine
                Einwilligung zur Speicherung von Cookies), erfolgt die Verarbeitung ausschließlich
                auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO; die Einwilligung ist jederzeit
                widerrufbar. Sie können Ihren Browser so einstellen, dass Sie über das Setzen von
