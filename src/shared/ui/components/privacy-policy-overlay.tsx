...
export function PrivacyPolicyOverlay({ isOpen, onClose }: PrivacyPolicyOverlayProps) {
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 p-8 relative max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-navaa-gray-600 hover:text-navaa-gray-900 transition-colors z-10"
        ...
        <div className="pr-8">
          ...
          <div className="space-y-6 text-navaa-gray-700 text-sm leading-relaxed">
            <section>
              ...
              <h4 className="font-semibold mb-2 mt-4">Allgemeine Hinweise</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Datenerfassung auf dieser Website</h4>
              ...
              <p className="mb-4">
                ...
                weiteren Fragen zum Datenschutz können Sie sich jederzeit an uns wenden.
              </p>
            </section>

            <section>
              <h3 className="font-semibold text-base mb-2">2. Hosting</h3>
              <p className="mb-4">
            ...
            <section>
              <h3 className="font-semibold text-base mb-2">3. Allgemeine Hinweise und Pflichtinformationen</h3>
              
              <h4 className="font-semibold mb-2 mt-4">Datenschutz</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Hinweis zur verantwortlichen Stelle</h4>
              ...
              <p className="mb-2">96049 Bamberg</p>
              <p className="mb-4">
                E-Mail: <a href="mailto:christian@christianmaass.com" className="text-blue-600 hover:text-blue-800 underline">christian@christianmaass.com</a>
              </p>

              <h4 className="font-semibold mb-2 mt-4">Speicherdauer</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h4>
              <p className="mb-4">
                WERDEN DIE PERSONENBEZOGENEN DATEN AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F DSGVO VERARBEITET, 
                ...
                ART. 21 ABS. 1 DSGVO). WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, 
                SO HABEN SIE DAS RECHT, JEDERZEIT WIDERSPRUCH GEGEN DIE VERARBEITUNG SIE BETREFFENDER PERSONENBEZOGENER 
                DATEN ZUM ZWECKE DERARTIGER WERBUNG EINZULEGEN; DIES GILT AUCH FÜR DAS PROFILING, SOWEIT ES MIT SOLCHER 
                DIREKTWERBUNG IN VERBINDUNG STEHT. WIDERSPRECHEN SIE, WERDEN IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND 
                NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH NACH ART. 21 ABS. 2 DSGVO).
              </p>

              <h4 className="font-semibold mb-2 mt-4">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Recht auf Datenübertragbarkeit</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">SSL- bzw. TLS-Verschlüsselung</h4>
              <p className="mb-4">
                ...
                von „http://" auf „https://" wechselt und an dem Schloss-Symbol in Ihrer Browserzeile. Wenn die SSL- 
                bzw. TLS-Verschlüsselung aktiviert ist, können die Daten, die Sie an uns übermitteln, nicht von Dritten 
                mitgelesen werden.
              </p>

              <h4 className="font-semibold mb-2 mt-4">Auskunft, Löschung und Berichtigung</h4>
              <p className="mb-4">
              ...
              <h4 className="font-semibold mb-2 mt-4">Recht auf Einschränkung der Verarbeitung</h4>
              <p className="mb-4">
                ...
                die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Wenn die Verarbeitung 
                Ihrer personenbezogenen Daten unrechtmäßig geschah/geschieht, können Sie statt der Löschung die 
                Einschränkung der Datenverarbeitung verlangen. Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen, 
                Sie sie jedoch zur Ausübung, Verteidigung oder Geltendmachung von Rechtsansprüchen benötigen, haben Sie 
                das Recht, statt der Löschung die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu 
                verlangen. Wenn Sie einen Widerspruch nach Art. 21 Abs. 1 DSGVO eingelegt haben, muss eine Abwägung 
                zwischen Ihren und unseren Interessen vorgenommen werden. Solange noch nicht feststeht, wessen Interessen 
            ...
            <section>
              <h3 className="font-semibold text-base mb-2">4. Datenerfassung auf dieser Website</h3>
              
              <h4 className="font-semibold mb-2 mt-4">Cookies</h4>
              <p className="mb-4">
                Diese Website verwendet Cookies. Cookies sind kleine Textdateien und richten auf Ihrem Endgerät keinen 
                Schaden an. Sie werden entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder dauerhaft 
                (dauerhafte Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies werden nach Ende Ihres Besuchs 
                automatisch gelöscht. Dauerhafte Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst 
                löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt. Teilweise können auch Cookies von 
                Drittunternehmen auf Ihrem Endgerät gespeichert werden, wenn Sie unsere Seite betreten (Third-Party-Cookies). 
                Diese ermöglichen uns oder Ihnen die Nutzung bestimmter Dienstleistungen des Drittunternehmens (z. B. Cookies 
                zur Abwicklung von Zahlungsdienstleistungen). Cookies haben verschiedene Funktionen. Zahlreiche Cookies sind 
                technisch notwendig, da bestimmte Websitefunktionen ohne diese nicht funktionieren würden (z. B. die 
                Warenkorbfunktion oder die Anzeige von Videos). Andere Cookies können zur Auswertung des Nutzerverhaltens 
                oder zu Werbezwecken verwendet werden. Sofern Cookies zur Datenverarbeitung auf Grundlage von Art. 6 Abs. 1 
                lit. f DSGVO gespeichert werden, ist unser berechtigtes Interesse die Verbesserung der Funktionalität unserer 
                Website. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B. eine Einwilligung zur Speicherung 
                ...
                Cookies informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von Cookies für bestimmte Fälle 
                oder generell ausschließen sowie das automatische Löschen der Cookies beim Schließen des Browsers aktivieren. 
                Bei der Deaktivierung von Cookies kann die Funktionalität dieser Website eingeschränkt sein.
              </p>

              <h4 className="font-semibold mb-2 mt-4">Server-Log-Dateien</h4>
              <p className="mb-4">
            ...
            <section>
              <h3 className="font-semibold text-base mb-2">5. Kontaktformular</h3>
              <p className="mb-4">
                ...
                Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO, sofern Ihre Anfrage mit 
                ...
                (Art. 6 Abs. 1 lit. a DSGVO), sofern diese abgefragt wurde. Die von Ihnen im Kontaktformular eingegebenen 
