        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-orange-700">
              <strong>Deine Aufgabe:</strong> Analysiere den Fall strukturiert und entwickle eine
              klare Empfehlung. Nutze bewährte Consulting-Frameworks und quantifiziere wo möglich.
            </p>
          </div>
        </div>
      </div>
