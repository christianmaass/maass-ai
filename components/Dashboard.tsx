...
const Dashboard: React.FC<DashboardProps> = ({ isNewUser = false }) => {
  ...
  const [currentView, setCurrentView] = useState<'welcome' | 'case' | 'response' | 'assessment'>('welcome');
                ...
                <div className="bg-white rounded-xl shadow-sm p-8">
                  <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">
                      Willkommen bei navaa.ai, {profile?.first_name || user?.email?.split('@')[0] || 'User'}! 🎉
                    </h1>
                    <p className="text-lg text-gray-600 mb-6">
                      Du bist erfolgreich registriert! Lass uns mit deinem ersten Case beginnen.
                    </p>
                  </div>
              ...
              {currentView === 'response' && currentCase && (
                <div className="bg-white rounded-xl shadow-sm p-8">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-6">Deine Antwort wird jetzt von unserer KI bewertet. Das dauert nur wenige Sekunden.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Bereit für dein nächstes Consulting-Training?
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {loading ? '...' : stats.averageScore > 0 ? `${stats.averageScore}/10` : 'Noch keine'}
                </p>
              </div>
