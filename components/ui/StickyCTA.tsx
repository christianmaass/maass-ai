...
export default function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 opacity-0 translate-y-5 animate-[fadeIn_0.3s_ease-out_forwards]">
      <a
        href="/chat"
        className="flex items-center px-6 py-3 bg-[#009e82] text-white font-semibold rounded-full shadow-lg hover:bg-[#007a66] hover:shadow-xl transition-all duration-300 transform hover:scale-105"
      >
