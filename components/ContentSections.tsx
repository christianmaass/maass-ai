...
export default function ContentSections() {
  return (
    <section className="w-full max-w-7xl mx-auto px-4 md:px-0 bg-[#f5f8fa]">

      {/* Überschrift und Erklärungstext über den Boxen */}
      <h2 className="text-2xl font-bold text-gray-900 mb-2 text-center">Was navaa für dich löst</h2>
      <p className="text-gray-700 text-center text-lg mb-8">Viele Führungskräfte treffen täglich komplexe Entscheidungen – ohne echtes Training.<br/>Diese 5 Herausforderungen sehen wir am häufigsten.</p>
      ...
      <div className="w-full max-w-7xl mx-auto mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-[#f5f8fa] rounded-2xl p-6 flex flex-col h-full shadow-lg font-sans">
  <h3 className="text-2xl font-bold text-gray-800 mb-4 text-center">Fehlendes Feedback auf Denk- und Entscheidungswege</h3>
  ...
  <div className="flex justify-center mt-8 mb-2">
    <div className="w-48 h-48 bg-gray-200 rounded-2xl flex items-center justify-center">
      <span className="text-gray-400 text-lg">Bild</span>
          ...
          {/* Card 2 */}
          <div className="bg-[#f5f8fa] rounded-2xl p-6 flex flex-col h-full shadow-lg font-sans">
  <h3 className="text-2xl font-bold text-gray-800 mb-4 text-center">Fehlende Orientierung und klare Entwicklungsimpulse</h3>
  ...
  <div className="flex justify-center mt-8 mb-2">
    <div className="w-48 h-48 bg-gray-200 rounded-2xl flex items-center justify-center">
      <span className="text-gray-400 text-lg">Bild</span>
          ...
          {/* Card 3 */}
          <div className="bg-[#f5f8fa] rounded-2xl p-6 flex flex-col h-full shadow-lg font-sans">
  <h3 className="text-2xl font-bold text-gray-800 mb-4 text-center">Unbewusstes und unstrukturiertes Denken</h3>
  ...
  <div className="flex justify-center mt-8 mb-2">
    <div className="w-48 h-48 bg-gray-200 rounded-2xl flex items-center justify-center">
      ...
      <div className="w-full max-w-4xl mx-auto mb-12">
        <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Für wen navaa Mehrwerte schafft</h3>
        <div className="bg-[#f5f8fa] rounded-2xl p-8 flex flex-col h-full shadow-lg font-sans">
  ...
  <table className="min-w-full border border-gray-200 rounded-xl">
    ...
    <tbody>
      ...
      <div id="so-funktionierts" className="bg-[#f5f8fa] shadow-lg rounded-2xl p-10 mb-12">
